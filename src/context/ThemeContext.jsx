...
export function ThemeProvider({ children }) {
  ...
  const fetchThemes = useCallback(async () => {
    try {
      ...
      if (data.success) {
        ...
        if (defaultTheme) {
          console.log("Setting current theme to:", defaultTheme.name)
  ...
  const createTheme = async (themeData) => {
    try {
      console.log("Creating new theme:", themeData.name)
      const response = await fetch("/api/themes", {
        method: "POST",
        headers: {
      ...
      if (data.success) {
        console.log("Theme created successfully:", data.theme)
  ...
  const updateTheme = async (id, updates) => {
    try {
      console.log("Updating theme:", id, updates)
      ...
      if (data.success) {
        console.log("Theme updated successfully:", data.theme)
  ...
  const setDefaultTheme = async (id) => {
    try {
      console.log("Setting theme as default:", id)
      ...
      if (data.success) {
        console.log("Theme set as default successfully:", data.theme)
