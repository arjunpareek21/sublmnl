...
export async function POST(request) {
  try {
    ...
    const { musicVolume, affirmationsVolume, repetitionInterval } = await request.json()

    // Validate settings
    if (musicVolume === undefined || affirmationsVolume === undefined || repetitionInterval === undefined) {
