          ...
          <div className="hidden md:flex items-center space-x-8">
              ...
              <>
                <Link
                  ...
                  style={{
                    color: isActive("/create") ? accentColor : "rgb(209, 213, 219)",
            ...
            <Link
              ...
              className="text-gray-300 hover:text-opacity-80 font-medium transition-colors"
              style={{
                color: isActive("/faq") ? accentColor : "rgb(209, 213, 219)",
                "&:hover": { color: primaryColor },
              }}
            >
              FAQ
            ...
            <Link
              ...
              style={{
                color: isActive("/contact") ? accentColor : "rgb(209, 213, 219)",
                "&:hover": { color: primaryColor },
              }}
          ...
          <div className="md:hidden mt-4 bg-gray-800 rounded-xl shadow-lg p-4 animate-fade-in border border-gray-700">
            <div className="flex flex-col space-y-4">
              ...
              {!user && (
                <Link
                  href="/auth"
                  className="text-white px-4 py-2 rounded-md text-center transition-colors"
                  style={{
                    backgroundColor: primaryColor,
                    "&:hover": { backgroundColor: `${primaryColor}DD` },
                  }}
